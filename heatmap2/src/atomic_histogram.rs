...
mod tests {
    ...
    fn percentiles() {
        ...
        for i in 0..=100 {
            ...
            assert_eq!(histogram.percentile(0.0), Some(Bucket { count: 1, lower: 0, upper: 0 }));
            assert_eq!(histogram.percentile(100.0), Some(Bucket { count: 1, lower: i, upper: i }));
        } 
        ...
        assert_eq!(histogram.percentile(99.9), Some(Bucket { count: 1, lower: 1024, upper: 1031 }));
    }
}
